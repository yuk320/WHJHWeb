<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpreadReturnReceiveRecordList.aspx.cs" Inherits="Game.Web.Module.AppManager.SpreadReturnReceiveRecordList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor = this.style.backgroundColor;this.style.backgroundColor = '#caebfc';this.style.cursor = 'default';"
                        ...
                        <td>
                            <%# GetAddressWithIP(Eval("ReceiveAddress").ToString()) %>
                        </td>
                    </tr>
                </ItemTemplate>

...
<body>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtSearch" runat="server" CssClass="text"></asp:TextBox>
                 ...
                 <asp:ListItem Value="2">按积分大于等于</asp:ListItem>
                 <asp:ListItem Value="3">按积分小于等于</asp:ListItem>
                 </asp:DropDownList>                
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <a class="l" href="javascript:void(0);" onclick="openWindowOwn('AccountsBaseInfo.aspx?param=<%#Eval("UserID").ToString() %>','<%#Eval("UserID").ToString() %>',,850,790);">
            ...
            <asp:Literal runat="server" ID="litNoSelect" Visible="true" Text="<tr class='tdbg'><td colspan='100' align='center'><br>默认不显示数据，请选择游戏后查询!<br><br></td></tr>"></asp:Literal>
        </table>
    </div>

    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('SystemMessageInfo.aspx')" />
            ...
            <asp:Repeater ID="rptSystemMessage" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="SystemMessageInfo.aspx?param=<%#Eval("ID") %>">编辑</a>              
                        </td>                
                        <td><%# Eval("StartTime")%></td>
                        <td><%# Eval("ConcludeTime")%></td>
                        <td><%# GetMessageTypeName((int)Eval("MessageType"))%></td>
                        <td><%# Game.Utils.TextUtility.CutRight(Eval("MessageString").ToString(),26)%></td>
                        <td><%# Eval("TimeRate")%></td>

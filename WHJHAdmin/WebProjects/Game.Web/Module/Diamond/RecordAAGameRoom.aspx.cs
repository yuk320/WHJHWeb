...
{
    public partial class RecordAAGameRoom : AdminPage
    {
        /// <summary>
        /// 页面加载
        /// </summary>
        ...
        protected void btnQuery1_Click(object sender, EventArgs e)
        {
            ...
            StringBuilder condition = new StringBuilder(" WHERE PayMode=1 ");
        ...
        public string SearchItems
        {
            get
            {
                ...
                {
                    ViewState["SearchItems"] = " WHERE PayMode=1";
                }

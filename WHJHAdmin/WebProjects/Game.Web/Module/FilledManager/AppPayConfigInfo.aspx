     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="True">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="赠送比例格式不正确" Display="Dynamic" ControlToValidate="txtScale" ForeColor="Red" ValidationExpression="^[0-9]{0,2}$"></asp:RegularExpressionValidator>
            </td>
        </tr>  
        <tr>
            <td class="listTdLeft">
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rbIdentity" runat="server" RepeatDirection="Horizontal">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordOpenRoom.aspx.cs" Inherits="Game.Web.Module.Diamond.RecordOpenRoom" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab1">房主支付</li>
                    <li class="tab2" onclick="Redirect('RecordAAGameRoom.aspx')">A A支付</li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg  Tmg7">
        <tr>
            ...
            <td>
                ...
                <input type="button" value="开房前50名" class="btn" style="width:85px;" onclick="openWindowOwn('TopOpenRoom.aspx', '', 850, 600);" />
                <span class="total-span">开房钻石统计：<asp:Label ID="lbTotal" runat="server" Text="0"></asp:Label></span>

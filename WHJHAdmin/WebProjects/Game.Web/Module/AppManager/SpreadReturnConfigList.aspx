<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpreadReturnConfigList.aspx.cs" Inherits="Game.Web.Module.AppManager.SpreadReturnConfigList" %>
...
<form id="form1" runat="server">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <td height="39" class="titleOpBg">
            <input type="button" value="新增" class="btn wd1" onclick="Redirect('SpreadReturnConfigInfo.aspx?cmd=add')"/>
            <input class="btnLine" type="button"/>
            <asp:Button ID="btnDelete" runat="server" Text="删除" CssClass="btn wd1"
                        onclick="btnDelete_Click" OnClientClick="return deleteop()"/>
            <input class="btnLine" type="button"/>
            <input class="btn wd3" type="button" value="推广返利记录" onclick="openWindowOwn('SpreadReturnRecordList.aspx?r=' + Math.random(), '推广返利记录', 1200, 700)"/>
            <input class="btnLine" type="button"/>
            <input class="btn wd3" type="button" value="领取返利记录" onclick="openWindowOwn('SpreadReturnReceiveRecordList.aspx?r=' + Math.random(), '推广返利记录', 1200, 700)"/>
        </td>
    </table>
    <div id="content">
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor = this.style.backgroundColor;this.style.backgroundColor = '#caebfc';this.style.cursor = 'default';"
                        ...
                        <td>
                            <a href="javascript:;" onclick="Redirect('SpreadReturnConfigInfo.aspx?param=<%# Eval("ConfigID") %>');" class="l">编辑</a>
                        </td>
                        <td>
                            <%# Eval("SpreadLevel") %>
                        </td>

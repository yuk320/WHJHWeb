<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TreasureConsume.aspx.cs" Inherits="Game.Web.Module.AccountManager.TreasureConsume" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg Tmg7">
        <tr>
            ...
            <td>
                <span style="color:red; font-weight:bold; line-height:26px;">金币总消耗量：
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">操作前银行金币
                </td>
                <td class="listTitle2">金币变化
                </td>
            ...
            <tr>
                <td colspan="2"></td>
                <td>
                    <div class="s-type hide" id="stype-list" style="height:80px;">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionList.aspx.cs" Inherits="Game.Web.Module.WebManager.QuestionList" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">你当前位置：网站系统 - 常见问题管理</td>
        </tr>
    </table>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('QuestionInfo.aspx')" />
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">序号</td>
                <td class="listTitle2">排序</td>
                <td class="listTitle2">问题</td>
                <td class="listTitle2">答案</td>
            ...
            <asp:Repeater ID="rptIssue" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="QuestionInfo.aspx?param=<%#Eval("ID") %>">编辑</a>              
                        </td>                
                        <td><%# Eval("ID") %></td>
                        <td><%# Eval("SortID") %></td>

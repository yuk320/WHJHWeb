<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyWaste.aspx.cs" Inherits="Game.Web.Module.DataStatistics.DailyWaste" %>
...
<body>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox><img
                    ...
                    style="cursor: pointer; vertical-align: middle" />
                <asp:DropDownList runat="server" ID="ddlKindList"/>
                <input type="button" id="search" value="查询" class="btn wd1" />
            </td>
        </tr>
    </table>
    <h2 style="text-align: center;margin-bottom: 5px;">每日损耗统计</h2>
    <div id="content">
    </div>
    <div id="tips" style="text-align: center;">没有数据</div>
    </form>
    <script type="text/javascript">
        ...
        chart.line().position('time*count').color('type').shape('smooth').size(2);
        chart.render();
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=GetWasteStatictics",
                data: { stime: $("#txtStartDate").val(), etime: $("#txtEndDate").val(), kindid:$("#ddlKindList").val() },

...
{
    public partial class RecordGoldExch : AdminPage
    {
        /// <summary>
        /// 页面加载
        /// </summary>
        ...
        {
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetList(RecordCurrencyExch.Tablename, anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
            anpNews.RecordCount = pagerSet.RecordCount;
            litNoData.Visible = pagerSet.PageSet.Tables[0].Rows.Count > 0 ? false : true;
            rptDataList.DataSource = pagerSet.PageSet;
            rptDataList.DataBind();

            TotalDiamondExch exch = FacadeManage.aideRecordFacade.GetTotalDiamondExchGold(SearchItems);
            lbTotalDiamond.Text = exch != null ? exch.ExchDiamond.ToString() : "0";
            lbTotalGold.Text = exch != null ? exch.PresentGold.ToString() : "0";
        }
        /// <summary>
        /// 查询条件
        /// </summary>

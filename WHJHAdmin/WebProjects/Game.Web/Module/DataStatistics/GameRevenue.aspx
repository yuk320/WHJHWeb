<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameRevenue.aspx.cs" Inherits="Game.Web.Module.DataStatistics.GameRevenue" %>
...
<body>
    ...
    <h2 style="text-align: center;margin-bottom: 5px;">每日游戏税收统计</h2>
    <div id="content">
    </div>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=getgamerevenuestatictics",

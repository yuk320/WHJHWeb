...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab1">限制地址</li>
                    <li class="tab2" onclick="Redirect('ConfineMachineList.aspx')">限制机器</li>
                </ul>
            </td>
        </tr>
    </table>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineAddressInfo.aspx?param="+Eval("AddrString").ToString()+"&reurl="+ Server.UrlEncode(Game.Utils.Utility.CurrentUrl) %>">编辑</a>
                        </td>
                        <td>
                ...
                <AlternatingItemTemplate>
                    <tr align="center" class="listBg" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineAddressInfo.aspx?param="+Eval("AddrString").ToString()+"&reurl="+ Game.Utils.Utility.CurrentUrl %>">编辑</a>
                        </td>
                        <td>
                            <%# Eval( "AddrString" ).ToString( )%>
                        </td>

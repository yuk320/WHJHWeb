<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordPresentTrade.aspx.cs" Inherits="Game.Web.Module.Diamond.RecordPresentTrade" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg  Tmg7">
        <tr>
            ...
            <td>
                ...
                <input type="button" value="转出前50名" class="btn" style="width:85px;" onclick="openWindowOwn('TopOutDiamond.aspx', '', 850, 600);" />
                <span class="total-span">赠送钻石统计：<asp:Label ID="lbTotal" runat="server" Text="0"></asp:Label></span>
            </td>
        </tr>
    </table>
    <div id="content">

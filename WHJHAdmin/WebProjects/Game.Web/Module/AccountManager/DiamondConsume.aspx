<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiamondConsume.aspx.cs" Inherits="Game.Web.Module.AccountManager.DiamondConsume" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg Tmg7">
        <tr>
            ...
            <td>
                <span style="color:red; font-weight:bold; line-height:26px;">钻石总消耗量：
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7" id="list">
            ...
            <tr>
                <td colspan="2"></td>
                <td>
                    <div class="s-type hide" id="stype-list" style="height:115px;">
                        <asp:CheckBoxList ID="cbType" runat="server" RepeatLayout="Flow">
                            <asp:ListItem Text="代理赠送" Value="7"></asp:ListItem>
                            <asp:ListItem Text="购买道具" Value="9"></asp:ListItem>
                            <asp:ListItem Text="创建房间" Value="10"></asp:ListItem>
                            <asp:ListItem Text="AA制游戏" Value="11"></asp:ListItem>
                        </asp:CheckBoxList>
                        <span class="s-btn">

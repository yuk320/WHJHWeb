<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatisticsChange.aspx.cs" Inherits="Game.Web.Module.Diamond.StatisticsChange" %>
...
<body>
        ...
        <tr>
            <td height="28">
                <ul>
                    ...
                    <li class="tab2" onclick="Redirect('StatisticsProduct.aspx')">产生钻石</li>
                    <li class="tab1">消耗钻石</li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <h2 style="text-align: center;margin-bottom: 5px;">平台钻石消耗</h2>
    <div id="content">
    </div>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=getplatformcostdiamond",

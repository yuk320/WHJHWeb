<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGoldBuyProp.aspx.cs" Inherits="Game.Web.Module.GoldManager.RecordGoldBuyProp" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('RecordGoldExch.aspx')">钻石兑换金币</li>
                    <li class="tab1">金币购买喇叭</li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg  Tmg7">
        <tr>
            ...
            <td>
                ...
                <span class="total-span">购买消耗金币统计：<asp:Label ID="lbTotalGold" runat="server" Text="0"></asp:Label></span>
            </td>
        </tr>
    </table>
    <div id="content">

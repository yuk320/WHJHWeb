<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatisticsProduct.aspx.cs" Inherits="Game.Web.Module.Diamond.StatisticsProduct" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('StatisticsDiamond.aspx')">平台钻石</li>
                    <li class="tab2" onclick="Redirect('StatisticsAgent.aspx')">代理钻石</li>
                    <li class="tab1">产生钻石</li>
                    <li class="tab2" onclick="Redirect('StatisticsChange.aspx')">消耗钻石</li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <h2 style="text-align: center;margin-bottom: 5px;">平台代理钻石</h2>
    <div id="content">
    </div>
    ...
    <script type="text/javascript">
        ...
        chart.line().position('time*diamond').color('type', ['#ff7f0e', '#2ca02c', '#1f77b4']).shape('smooth').size(2);
        chart.render();
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=getplatformproductdiamond",

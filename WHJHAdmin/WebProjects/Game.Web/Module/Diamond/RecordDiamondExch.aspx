<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordDiamondExch.aspx.cs" Inherits="Game.Web.Module.Diamond.RecordDiamondExch" %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlSearchType" runat="server">
                    ...
                    <asp:ListItem Value="3">按用户昵称</asp:ListItem>
                </asp:DropDownList>
                <asp:Button ID="Button1" runat="server" Text="查询" CssClass="btn wd1" OnClick="btnQuery1_Click" />
                <input type="button" value="兑换前50名" class="btn" style="width:85px;" onclick="openWindowOwn('TopExchangeGold.aspx', '', 850, 600);" />
                <span class="total-span">统计：<asp:Label ID="lbTotal" runat="server" Text="0"></asp:Label></span>
            </td>
        </tr>
    </table>
    <div id="content">

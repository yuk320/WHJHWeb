...
namespace Game.Web.Module.Diamond
{
    public partial class RecordBuyHorn : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetList(RecordBuyNewProperty.Tablename, anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
            anpNews.RecordCount = pagerSet.RecordCount;
            litNoData.Visible = pagerSet.PageSet.Tables[0].Rows.Count > 0 ? false : true;
            rptDataList.DataSource = pagerSet.PageSet;
            rptDataList.DataBind();
            lbTotal.Text = FacadeManage.aideRecordFacade.GetTotalBuyHornDiamond(SearchItems).ToString();
        }
        /// <summary>
        /// 查询条件
        /// </summary>

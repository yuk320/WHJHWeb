...
{
    public partial class RecordGoldBuyProp : AdminPage
    {
        /// <summary>
        /// 页面加载
        /// </summary>
        ...
        {
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetList(RecordGoldBuyProperty.Tablename, anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
            anpNews.RecordCount = pagerSet.RecordCount;
            litNoData.Visible = pagerSet.PageSet.Tables[0].Rows.Count > 0 ? false : true;
            rptDataList.DataSource = pagerSet.PageSet;
            rptDataList.DataBind();

            lbTotalGold.Text = FacadeManage.aideRecordFacade.GetTotalBuyHornGold(SearchItems).ToString();
        }
        /// <summary>
        /// 查询条件
        /// </summary>
